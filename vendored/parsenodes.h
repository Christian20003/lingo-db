...
using BoolExprType = enum BoolExprType { AND_EXPR,
                                         OR_EXPR,
                                         NOT_EXPR };
...
using SortByNulls = enum SortByNulls { SORTBY_NULLS_DEFAULT,
                                       SORTBY_NULLS_FIRST,
                                       SORTBY_NULLS_LAST };
...
using ViewCheckOption = enum ViewCheckOption { NO_CHECK_OPTION,
                                               LOCAL_CHECK_OPTION,
