...
void frontend::sql::Parser::translateCopyStatement(mlir::OpBuilder& builder, CopyStmt* copyStatement) {
   ...
   auto hasHeaderValue = builder.create<db::ConstantOp>(builder.getUnknownLoc(), builder.getI1Type(), builder.getIntegerAttr(builder.getI1Type(), hasHeader));
   rt::RelationHelper::copyFromIntoTable(builder, builder.getUnknownLoc())(mlir::ValueRange{tableNameValue, fileNameValue, delimiterValue, escapeValue, hasHeaderValue});
}
